...
def criacao_agendamento_teste():
    ...
    try:
        ...
        response = requests.post(f'{url_base}/criar-agendamento', json={
            'cliente_id': 1,
            'barbeiro_id': 1,
            'servico_id': 1,
...
def horario_funcionamento_teste():
    ...
    try:
        ...
        print(f'❌ Erro ao testar horario de funcionamento apos o fechamento do estabelecimento: {e}')
        relatorio['horario_funcionamento']['apos_fechamento'] = False
    ...
    try:
        ...
        print(f'❌ Erro ao testar horario de funcionamento antes da abertura do estabelecimento: {e}')
        relatorio['horario_funcionamento']['antes_abertura'] = False
        print("----------------------------------")
