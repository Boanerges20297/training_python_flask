...
class BarbeiroSchema(BaseModel):
    ...
    motivo_ausencia: str | None = Field(default=None, description="Motivo da ausência caso inativo")
    ...
    def validar_ausencia(self):
        if self.ativo is False and not self.motivo_ausencia:
            raise ValueError("O motivo da ausência é obrigatório quando o barbeiro está inativo")
