...
def get_ganhos_totais():
    ...
    return jsonify({"message": f"Ganhos totais do {periodo} obtidos com sucesso", "data": ganhos}), 200
...
def get_ganhos_barbeiros():
    ...
    return jsonify({"message": f"Ganhos dos barbeiros do {periodo} obtidos com sucesso", "data": ganhos}), 200
...
def get_atendimentos_gerais():
    ...
    if not data_inicio or not data_fim:
        return jsonify({"message": "data_inicio e data_fim são obrigatórios (formato YYYY-MM-DD)"}), 400
    ...
    return jsonify({"message": "Atendimentos gerais obtidos com sucesso", "data": atendimentos}), 200
...
def get_atendimentos_barbeiros():
    ...
    return jsonify({"message": "Atendimentos por barbeiro obtidos com sucesso", "data": atendimentos}), 200
...
def get_servico_mais_procurado():
    ...
    return jsonify({"message": "Serviço mais procurado obtido com sucesso", "data": servico}), 200
...
def get_cliente_mais_atendimentos():
    ...
    return jsonify({"message": "Cliente com mais atendimentos obtido com sucesso", "data": cliente}), 200