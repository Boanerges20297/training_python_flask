...
from app import db
from app.utils.security.decorators import admin_required, barbeiro_required
from flask_jwt_extended import jwt_required, get_jwt_identity, get_jwt
from app.modules.barbeiro.schema import BarbeiroSchema, BarbeiroUpdateSchema
...
def obter_ranking_barbeiros():
    try:
        ...
        from app.modules.barbeiro.schema import BarbeiroDesempenhoSchema
