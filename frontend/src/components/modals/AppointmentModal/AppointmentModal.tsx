...
import { X, User, ShoppingBag, Calendar, FileText, Loader2, CheckCircle2, Plus } from 'lucide-react';
...
const AppointmentModal: React.FC<AppointmentModalProps> = ({ isOpen, onClose, onSuccess, clientes, servicos }) => {
